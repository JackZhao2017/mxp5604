...
/*
 *
 * FILE : MPC5604C_M27V_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5604C_M27V derivative needed initializations, 
 *  and all initializations for the MPC5604C_M27V boards which are supported.
...
#include "MPC5604C_M27V.h"      /* MPC56xx platform development header            */
#include "MPC5604C_M27V_HWInit.h"
...
/*******************************************************/
/* MPC5604C_M27V derivative specific hardware initialization */
/*******************************************************/
...
nofralloc
    ...
    /* MPC5604C_M27V SRAM initialization code                              */
    lis r11,L2SRAM_LOCATION@h       /* Base of SRAM, 64-bit word aligned */
    ori r11,r11,L2SRAM_LOCATION@l

    li r12,384        /* Loops to cover 48K SRAM; 32k/4 bytes/32 GPRs = 384 */
    mtctr r12
...
/*******************************************************/
/* MPC5604C_M27V boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5604C_M27VDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5604C_M27VDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5604C_M27V external bus
        Set up the pins
